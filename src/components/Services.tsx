...
const services = [
  {
    ...
    description: 'Круглосуточный мониторинг и контроль охранных систем с мгновенным реагированием на тревожные сигналы. Современное оборудование и квалифицированные операторы.'
  },
  {
    icon: 'Users',
